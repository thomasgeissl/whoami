...
export default () => {
  ...
  return (
    <Section headline={"Past, present, future"}>
      ...
      <p>
        Yes, I know how to operate a fork lift. But after realizing that this is
      ...
      <p>
        Currently, I work as a creative technologist at IXDS, besides that I do
        some smaller freelance projects.
      </p>
      <p>
        I am available for new freelance jobs, and open for new permanent
        positions as well.
      </p>
    </Section>
  )
