...
export default function Template({ data }) {
  ...
  return (
    <div className={classes.root}>
      <div className="about" dangerouslySetInnerHTML={{ __html: about.html }} />
      <div
        className="projects"
      ...
      >
        ...
        <ul>
          <li>
            Spinning vinyls with the grantler soundsystem dj collective. Mostly
            playing postpunk, 80s, dark wave, shoegaze and dreampop. <br></br>
          ...
          <li>
            ...
            Video by <a href="https://www.instagram.com/dava_dnb/">dava_dnb</a>{" "}
            taken at <a href="https://reservoir.space">reservoir festival</a>.
