...
import Project from "../components/projects/Base"
        ...
        <List>
          <Project date={"in 2020"}>
            <p>
              ...
              projects during the Covid-19 pandemic. vjam is a virtual jam
              session system, where users can create virtual jam session rooms
              and play music together. vgig is virtual concert hall system. it
              adds omni directional communication to virtual concerts,
              communication between audience and performers, as well as audience
              and audience. vgig is a collaboration with artist and composer{" "}
              <a
          ...
          <Project date={"in 2020"}>
            ...
            <p>
              ...
              working. Some parts of the tool are already open source, e.g. its{" "}
              <a
          ...
          <Project date={"since 2018"}>
            <Grid container className="media">
              <Grid item xs={12} sm={4}>
                <p>
                  <a href="https://klanglichtstrom.de">klanglichtstrom</a> is an
          ...
          <Project date={"since 2020"}>
            <p>
              ...
              wanna support honest music that touches us. Besides the label, we
              run a small blog and dj collective.
            </p>
            <p>
          ...
          <Project date={"since 2018"}>
            <p>
              As written earlier, music is a big thing in my life. Here are some
              of my most recent musical projects.
            </p>
          ...
          <Project date={"since 2012"}>
            ...
            from interior design to live visuals and everything in between. E.g.{" "}
